...
// generated end
  ...
  public void returnCopy(Copy c) {
    // generated start
Loan loan = c.getLoans().stream()
    .filter(l -> l.getMember().equals(this) && !l.getClosed())
    .findFirst()
    .orElseThrow(() -> new IllegalArgumentException("No non-closed loan found for this copy and member"));
