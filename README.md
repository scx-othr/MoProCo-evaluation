...
- **Modeling complexity**: Given the MoProCo specification and an equivalent set of PlantUML models, this metric compares (1) the number of distinct element types (e.g., association) used, and (2) the number of model elements used in total. [Results](model_elements.md) (manually created based on the `cdiag` and `puml` files of each case study)
