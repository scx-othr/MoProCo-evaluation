...
MoProCo offers a unified textual syntax for UML-like class models. For operations and constructors, natural language specifications can be provided directly in the language. From MoProCo models, Java code is generated in a two-phase procedure:
...
A scientific journal publication utilizing the raw data contained here for the evaluation of the MoProCo approach is currently under review. It will be linked here once accepted.
...
The case studies represent software engineering activities in design and implementation. The models, prompts and code are dedicated to the *business logic* of these applications.
...
- **Black-box LLM prompts and code generated from them (5 runs)**. The LLM prompts reflect the structure and behavior of the models for each case study. The runs were executed as separate prompts to OpenWebUI. We record the response, usage data, and additional observations for each run.
- **MoProCo specifications and code generated from them (5 runs)**. The classical UML model structure has been replicated. Behavior has been added as natural language prompts. We record the output of the first, deterministic phase, as well as the completed source code, usage data, and additional observations for each rune of the second, LLM-based phase of the generation process.
- **Test suites for MoProCo-generated code** We provide JUnit tests for each case study. For each operation specified using natural language, at least two test cases exist. (Test suites contained in different subdirectories per run are identical.)

### Quick links to artifacts per case study
|             | **classical UML** | **black-box LLM** | **MoProCo** | **Test suites** |
|------------:|:------------------|:------------------|:------------|:---------------| 
| **airline** | [diagrams](airline/classical-uml/index.md) | [prompt](airline/blackbox-llm/prompt.md), generated code ([1](airline/blackbox-llm/1) [2](airline/blackbox-llm/2) [3](airline/blackbox-llm/3) [4](airline/blackbox-llm/4) [5](airline/blackbox-llm/5)), [observations](airline/blackbox-llm/observations.md) | [model](airline/moproco/airline.cdiag), generated code ([1](airline/moproco/1) [2](airline/moproco/2) [3](airline/moproco/3) [4](airline/moproco/4) [5](airline/moproco/5)), [observations](airline/moproco/observations.md) | [test suite](airline/moproco/1/test)
| **library** | [diagrams](library/classical-uml/index.md) | [prompt](library/blackbox-llm/prompt.md), generated code ([1](library/blackbox-llm/1) [2](library/blackbox-llm/2) [3](library/blackbox-llm/3) [4](library/blackbox-llm/4) [5](library/blackbox-llm/5)), [observations](library/blackbox-llm/observations.md) | [model](library/moproco/library.cdiag), generated code ([1](library/moproco/1) [2](library/moproco/2) [3](library/moproco/3) [4](library/moproco/4) [5](library/moproco/5)), [observations](library/moproco/observations.md) | [test suite](library/moproco/1/test)
| **shop**    | [diagrams](shop/classical-uml/index.md) | [prompt](shop/blackbox-llm/prompt.md), generated code ([1](shop/blackbox-llm/1) [2](shop/blackbox-llm/2) [3](shop/blackbox-llm/3) [4](shop/blackbox-llm/4) [5](shop/blackbox-llm/5)), [observations](shop/blackbox-llm/observations.md) | [model](shop/moproco/shop.cdiag), generated code ([1](shop/moproco/1) [2](shop/moproco/2) [3](shop/moproco/3) [4](shop/moproco/4) [5](shop/moproco/5)), [observations](shop/moproco/observations.md) | [test suite](shop/moproco/1/test)
...
- **Productivity**: The ratio between the size of a MoProCo model and (1) the Java source code generated from it as well as (2) the PlantUML code required to construct an equivalent model using classical UML modeling. A lines of code metric is used to this end (where blank lines, comments, and lines only containing `}` are not counted). [Results](loc.md) (generated by the evaluation script [loc.py](loc.py))
- **Cognitive Complexity for Modeling**: Given the MoProCo specification and an equivalent set of PlantUML models, this metric compares (1) the number of distinct element types (e.g., association) used, and (2) the number of model elements used in total. [Results](model_elements.md) (manually created based on the `cdiag` and `puml` files of each case study)
...
[Felix Schwägerl](mailto:felix.schwaegerl@oth-regensburg.de)
[Thomas Buchmann](mailto:thomas.buchmann@hof-university.de)
